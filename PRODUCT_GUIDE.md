...
## 5. 叙事法则 (The Narrative Edge)

基于 *Authentic Storytelling that Meets the Moment* 的核心理念，我们确立以下内容创作的最高指导原则：

### 5.1 Authenticity (极致真诚)
> **"真诚是通往人心的捷径。"**

*   **原则**: 在 AI 生成内容泛滥的时代，**人味 (Humanity)** 是最稀缺的资源。不要试图扮演完美的专家，要敢于展示过程、挣扎和真实。
*   **执行**: 
    *   多分享 "WIP" (Work In Progress) 的状态，而不仅仅是完美的终局。
    *   坦诚地谈论焦虑、失败和不确定性，而不仅仅是成功和效率。
*   **禁忌**: 拒绝 Corporate Jargon (黑话) 和 Marketing Fluff (营销废话)。

### 5.2 Clarity & Directness (简洁有力)
> **"不要花里花俏。"**

*   **原则**: 好的观点不需要复杂的辞藻来包装。设计服务于内容，形式服务于思想。
*   **执行**: 
    *   文字直接、有力、温暖。
    *   用最朴素的语言描述最深刻的道理。
    *   如果一句话能说完，绝不写一段。
...
*   **原则**: 每一篇内容都是一封写给"同频者"的信。
*   **执行**: 
    *   关注读者的**当下情绪** (Meet the Moment)。回应他们内心的焦虑与渴望。
    *   不仅仅提供信息 (Information)，更提供**意义 (Meaning)** 和 **陪伴 (Companionship)**。

## 6. 技术架构备忘 (Tech Stack Notes)
